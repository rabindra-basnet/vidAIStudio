      ...
      <div className="container mx-auto px-4">
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-gray-600 max-w-2xl mx-auto">
            Ready to transform your video creation process? Contact us today and let's bring your vision to life.
          </p>
        </div>
        ...
        <div className="grid lg:grid-cols-2 gap-12 max-w-6xl mx-auto">
              ...
              <div className="space-y-4">
                <div className="flex items-center space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">hello@vidaistudio.com</p>
                  </div>
                </div>
          ...
          <div className="bg-white rounded-2xl p-8 shadow-lg">
            ...
            <form className="space-y-6">
              ...
              <Button
                type="submit"
                className="w-full bg-[#EFB034] text-[#5D4108] shadow-xs hover:bg-[#D29211] hover:active:bg-[#B57E0F] disabled:opacity-40 focus-visible:ring-[#EFB034]/20 dark:focus-visible:ring-[#EFB034]/40"
              >
